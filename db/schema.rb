...
ActiveRecord::Schema.define(version: 2022_04_24_080500) do
  ...
  create_table "attached_images", force: :cascade do |t|
    t.text "content"
    t.integer "general_item_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["general_item_id", "created_at"], name: "index_attached_images_on_general_item_id_and_created_at"
    t.index ["general_item_id"], name: "index_attached_images_on_general_item_id"
  end
  ...
  create_table "general_items", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["created_at"], name: "index_general_items_on_created_at"
  ...
  create_table "item_types", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["content"], name: "index_item_types_on_content"
  end
  ...
  add_foreign_key "attached_images", "general_items"
